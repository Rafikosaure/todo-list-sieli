...
import { AddSvg } from './logo';
import { DeleteSvg as CloseSvg } from './logo';
import "../styles/Dashboard.scss";
import { URL_ADD_TASK, URL_DELETE_TASK, URL_GET_TASKS, URL_UPDATE_TASK } from '../urls/urls';
...
function Dashboard() {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            const response = await axios.post(URL_ADD_TASK, task);
    ...
    const fetchTasks = async () => {
        ...
        try{
            const response = await axios.get(URL_GET_TASKS);
    ...
    const deleteTask = async (id) => {
      try{
        // sends request to delete
          const response = await axios.delete(URL_DELETE_TASK.replace("id", id));
          // updates tasksList state
          console.log(response);
          fetchTasks();
      }catch(e){
    ...
    const updateTask = async (e, id) => {
      try{
        ...
        // }
          ...
          const response = await axios.put(URL_UPDATE_TASK.replace("id", id), /*actualcontentxd*/);
          // updates tasksList state
          console.log(response);
          // ??
          fetchTasks();
